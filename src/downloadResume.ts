...
export const downloadResume = async () => {
  ...
  const exportYearMonth = new Date().toLocaleDateString('ja-JP', { year: 'numeric', month: '2-digit' });
  ...
  worksheet.getCell('A1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('D1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('H1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('K1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('N1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A3').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A4').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A5').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A6').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A7').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  worksheet.getCell('A8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
  ...
  sortedData.forEach((item, index) => {
    ...
    worksheet.getCell('A' + SR).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell('E' + SR).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell('H' + SR).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`A${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`F${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`H${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`J${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`L${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`M${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`N${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`O${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
    ...
    worksheet.getCell(`P${SR + 1}`).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFEEEEEE' }};
